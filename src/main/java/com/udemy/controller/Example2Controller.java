...
import static com.udemy.controller.ExampleController.EXAMPLE_VIEW;
...
public class Example2Controller {
    ...
    //localhost:8080/example2/request1?nm=fer
    @GetMapping("/request1")
    public ModelAndView request1(@RequestParam(name="nm",required=false, defaultValue = "vacio") String name) {
    ...
    //localhost:8080/example2/request2/fer
